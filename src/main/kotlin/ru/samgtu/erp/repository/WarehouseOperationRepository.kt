...
interface WarehouseOperationRepository : JpaRepository<WarehouseOperation, Long> {
    @Query(value = "SELECT warehouseOperation FROM WarehouseOperation warehouseOperation " +
            "INNER JOIN warehouseOperation.warehouse warehouse " +
            "INNER JOIN warehouse.organization organization " +
            "WHERE organization.id = :id")
    fun findAllByOrganization(@Param("id") id: Long,
                              pageable: Pageable): Page<WarehouseOperation>
    ...
    fun findAllByOrganizationAndWarehouse(@Param("organizationId") organizationId: Long,
